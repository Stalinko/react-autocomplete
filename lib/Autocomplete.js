...
class Autocomplete extends React.Component {
  ...
  static propTypes = {
    ...
    /**
     * Arguments: `items: Array<Any>, value: String, styles: Object, refCallback: Function`
     *
     * Invoked to generate the render tree for the dropdown menu. Ensure the
     * returned tree includes every entry in `items` or else the highlight order
     * and keyboard navigation logic will break. `styles` will contain
     * { top, left, minWidth } which are the coordinates of the top-left corner
     * and the width of the dropdown menu. `refCallback` is a function which you can invoke
     * to manually set the `ref` to the scrollable menu container in case when menu html has
  ...
  renderMenu() {
    ...
    const menu = this.props.renderMenu(items, this.props.value, style, ref => this.refs.menu = ref)
    return React.cloneElement(menu, {
      ref: e => !this.refs.menu && (this.refs.menu = e),
